...
public class LanguageTranslatorExample {
  ...
  public static void main(String[] args) {
    Authenticator authenticator = new IamAuthenticator("KYXGV21JpOCN-uUMwZ5bB9pDSrjoABht4JdramrnXeiW");
    LanguageTranslator service = new LanguageTranslator("2018-05-01", authenticator);

    TranslateOptions translateOptions = new TranslateOptions.Builder()
        .addText("I am Fabrizzio Coltro and i work as a teacher in utn java courses")
        .modelId("en-")
        .build();
